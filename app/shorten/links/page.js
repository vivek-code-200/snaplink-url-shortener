...
const page = () => {
    ...
    return (
        <div className='text-gray-500 p-5 lg:px-16'>
            <ToastContainer
                position="top-right"
                autoClose={5000}
                hideProgressBar={false}
                                ...
                                <tr key={item._id} className=''>
                                    ...
                                    <td className='w-1/3 text-center py-4 '>
                                        <div className='lg:flex hidden  justify-center gap-3'>
                                            ...
                                            <span onClick={() => { handleDelete(item._id) }} className='text-center bg-[rgba(255,255,255,0)] border-x-1 border-gray-500 flex items-center gap-1 p-1 px-3 rounded-full text-gray-300 opacity-40 hover:opacity-90 justify-center w-fit cursor-pointer hover:text-gray-300 text-[14px]'>Delete<Image className='invert-100' alt='delete symbol' width={15} height={15} src="/delete.svg" /></span>
                                        </div>
                                        <div className=' flex lg:hidden  justify-center gap-2'>
                                            ...
                                            <span onClick={() => { handleDelete(item._id) }} className='p-2 bg-[rgba(255,255,255,0)] border-1 border-gray-500  items-center rounded-full  opacity-40 hover:opacity-90 flex justify-center  cursor-pointer hover:text-gray-300 '><Image className='invert-100' alt='delete symbol' width={15} height={35} src="/delete.svg" /></span>
                                        </div>
                                    </td>
                                </tr>
                            )
