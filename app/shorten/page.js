...
export default function page() {
    ...
    return (
        <div className='text-white flex my-20 flex-col items-center justify-center'>
            <ToastContainer
                position="top-right"
                autoClose={5000}
                hideProgressBar={false}
            ...
            <div className='mt-10 p-10 px-14 flex flex-col gap-6 rounded-lg border-[0px] bg-[rgba(255,0,183,0.04)]'>
